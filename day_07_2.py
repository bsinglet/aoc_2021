...
def minimize_fuel(my_lines):
	...
	best_fuel = None
	# there's probably a way to calculate the median weighted in this way,
	# but I was in a hurry, so I'm just brute-forcing the costs of all
	# possible alignment points and choosing the lowest one.
